...
$query = "SELECT * FROM subasta ORDER BY inicia LIMIT $empieza, $por_pagina";
				...
				<tbody>
					...
					while ($fila = mysqli_fetch_assoc($resultado)) {
						...
						<tr>
                            ...
                            <td><?php echo utf8_encode(utf8_decode($inicioDate)); ?></td>
							<td><?php echo utf8_encode(utf8_decode($fecha)); ?></td>
							<td>
								<a style="color: white;" role="button" href="cancelarSubasta.php?id=<?php echo $id; ?>" class="btn btn-danger btn-block">Cancelar Subasta</a>
							</td>
						</tr>
					<?php
					}
							...
							<ul class="pagination">
								...
								for ($i = 1; $i < $total_paginas; $i++) {
									echo "<li class='page-item'>
										<a href='cancelarSubastas.php?pagina=" . $i . "' class='page-link'>" . $i . "</a>
									  </li>";
								}


								//link a la ultima pagina
								echo "<li class='page-item'><a href='cancelarSubastas.php?pagina=$total_paginas' class='page-link'>" . 'Ultimos registros' . "</a></li>";
							}
						}
						?>

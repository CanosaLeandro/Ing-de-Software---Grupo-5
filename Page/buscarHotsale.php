...
<head>
    ...
    $query = "SELECT * FROM residencia WHERE en_hotsale = 'si' AND activo = 'si' ORDER BY ubicacion LIMIT $empieza, $por_pagina";
...
<body>
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='residenciaHotsale.php?id=<?php echo $id;?>'><button type="button " class="btn btn-info"><span>Ver Hotsale</span></button></a>
                        </td>
                    </tr> 
                    <?php };?>
                </tbody>
            ...
            <?php
                $qry="SELECT * FROM residencia WHERE en_hotsale = 'si' AND activo = 'si'";
							...
							<ul class="pagination">
								...
								for ($i = 1; $i < $total_paginas; $i++) {
									echo "<li class='page-item'>
										<a href='buscarHotsale.php?pagina=" . $i . "' class='page-link'>" . $i . "</a>
									  </li>";
								}


								//link a la ultima pagina
								echo "<li class='page-item'><a href='buscarHotsale.php?pagina=$total_paginas' class='page-link'>" . 'Ultimos registros' . "</a></li>";
							}
						}
						?>
